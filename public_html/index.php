...
<head>
    ...
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1697678007968221&ev=PageView&noscript=1"/></noscript>
    <!-- End Meta Pixel Code -->
</head>
<body>
    <header>
        ...
        <a href="https://superprofile.bio/vp/ms-office-and-windows?checkout=true" class="btn-primary buy-btn">GET IT NOW</a>
    </header>
    ...
    <section id="faq" style="background: var(--bg-light);">
        ...
        <div style="max-width: 700px; margin: 0 auto;">
            ...
            <div class="faq-item">
                <div class="faq-question">Is it lifetime valid? <span>+</span></div>
                <div class="faq-answer">The advertised product is provided with lifetime validity as specified on the product page. There are no recurring monthly or yearly charges for the advertised offer.</div>
            </div>
            <div class="faq-item">
                <div class="faq-question">Do I need to pay every month? <span>+</span></div>
                <div class="faq-answer">No. The advertised offer is a one-time payment of ₹99 with no additional monthly or yearly subscription charge.</div>
            </div>
        </div>
    </section>
